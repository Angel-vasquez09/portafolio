            ...
            <div className='absolute bottom-0 left-4 blur-[135px] w-[30%] h-[30%]  rounded-full bg-secondary'></div>
                <div className='w-full'>
                    ...
                    <div className='w-full mt-4 flex justify-center'>
                        ...
                        <div className='w-[90%] md:w-96 h-80 grid grid-rows-5 border-2 border-secondary rounded-xl bg-transparent/30 backdrop-blur-sm'>
                            <div className='row-span-1 flex items-center pl-2'>
                                <h2 className='text-xl text-secondary text-bold'>Angel Peli</h2>
                            </div>
                            <div className="relative row-span-3 bg-[url('/imgs/proyecto1/img1.jpg')] bg-cover">
